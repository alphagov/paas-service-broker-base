...
type FakeServiceProvider struct {
	...
	DeprovisionStub        func(context.Context, provider.DeprovisionData) (string, bool, error)
	...
	ProvisionStub        func(context.Context, provider.ProvisionData) (string, string, bool, error)
	...
	UpdateStub        func(context.Context, provider.UpdateData) (string, bool, error)
...
func (fake *FakeServiceProvider) Deprovision(arg1 context.Context, arg2 provider.DeprovisionData) (string, bool, error) {
...
func (fake *FakeServiceProvider) DeprovisionCalls(stub func(context.Context, provider.DeprovisionData) (string, bool, error)) {
	fake.deprovisionMutex.Lock()
...
func (fake *FakeServiceProvider) Provision(arg1 context.Context, arg2 provider.ProvisionData) (string, string, bool, error) {
...
func (fake *FakeServiceProvider) ProvisionCalls(stub func(context.Context, provider.ProvisionData) (string, string, bool, error)) {
	fake.provisionMutex.Lock()
...
func (fake *FakeServiceProvider) Unbind(arg1 context.Context, arg2 provider.UnbindData) (domain.UnbindSpec, error) {
...
func (fake *FakeServiceProvider) UnbindCalls(stub func(context.Context, provider.UnbindData) (domain.UnbindSpec, error)) {
	fake.unbindMutex.Lock()
...
func (fake *FakeServiceProvider) UnbindReturns(result1 domain.UnbindSpec, result2 error) {
	fake.unbindMutex.Lock()
	defer fake.unbindMutex.Unlock()
	fake.UnbindStub = nil
...
func (fake *FakeServiceProvider) UnbindReturnsOnCall(i int, result1 domain.UnbindSpec, result2 error) {
	fake.unbindMutex.Lock()
	defer fake.unbindMutex.Unlock()
	fake.UnbindStub = nil
...
func (fake *FakeServiceProvider) Update(arg1 context.Context, arg2 provider.UpdateData) (string, bool, error) {
...
func (fake *FakeServiceProvider) UpdateCalls(stub func(context.Context, provider.UpdateData) (string, bool, error)) {
	fake.updateMutex.Lock()
