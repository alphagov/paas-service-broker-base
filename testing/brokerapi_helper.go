...
func (b *BrokerAPIClient) ProvisionInstance(instanceID, serviceID, planID string, paramJSON string) (responseCode int, operation string, err error) {
	...
	return resp.StatusCode, provisioningResponse.OperationData, nil
}
...
func (b *BrokerAPIClient) GetLastOperationState(instanceID, serviceID, planID, operation string) (domain.LastOperationState, error) {
